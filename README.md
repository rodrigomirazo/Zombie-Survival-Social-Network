...
1. Please use one of the following languages/frameworks: *Java/Kotlin* or *Javascript (Node + Express)* - listed in descending order of desirability. It's also possible to implement a solution using *Ruby (Rails)* or *Elixir (Phoenix)*, but if you want to do so, please notify us in advance.
